    ...
    <>
      ...
      <Navbar expand="lg" style={{  background: '#ebc334' }}>
        <Container fluid>
          ...
          <button style={{background:'transparent', borderColor:'transparent' ,marginLeft:'30px'}} onClick={()=>sortByRateUp() }>Sort by Rate </button> 
          <button style={{background:'transparent', borderColor:'transparent' ,marginLeft:'30px'}} onClick={()=>sortByRateDown() }>Sort by Rate </button>   
          <Nav
